...
public static class StringResources
{
    ...
    public static string FileHeader19 => StringRM.GetString("strFileHeader19", Culture) ?? "days, day, days, days, days, days";
    public static string FileHeader20 => StringRM.GetString("strFileHeader20", Culture) ?? "hours, hour, hours, hours, hours, hours";
    public static string FileHeader21 => StringRM.GetString("strFileHeader21", Culture) ?? "minutes, minute, minutes, minutes, minutes, minutes";
    public static string FileHeader22 => StringRM.GetString("strFileHeader22", Culture) ?? "seconds, second, seconds, seconds, seconds, seconds";
    public static string FileHeader23 => StringRM.GetString("strFileHeader23", Culture) ?? "and";
    public static string FileHeader24 => StringRM.GetString("strFileHeader24", Culture) ?? "milliseconds, millisecond, milliseconds, milliseconds, milliseconds, milliseconds";
